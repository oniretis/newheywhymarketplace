  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className={
          contentClassName ??
          "max-w-[95vw] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] xl:max-w-[900px] max-h-[90vh] overflow-y-auto"
        }
      >
        <DialogHeader>
          <DialogTitle>
        ...
        <Form form={form} className="space-y-4">
          <div className="grid gap-4 sm:gap-6 max-h-[60vh] overflow-y-auto pr-2">
